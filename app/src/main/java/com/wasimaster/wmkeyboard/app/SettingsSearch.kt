...
private val SettingRows: List<SettingsSearchEntry> = listOfNotNull(
    ...
    entry("Forget after pasting a password", "Delete a clip from history and the system clipboard once it's pasted into a password field", tool = ToolbarTool.CLIPBOARD),
    ...
    entry("First calendar", "Bengali, Hijri, Chinese, Hebrew, Hindu, Persian, Buddhist or Japanese alongside the Gregorian one", tool = ToolbarTool.CALENDAR),
