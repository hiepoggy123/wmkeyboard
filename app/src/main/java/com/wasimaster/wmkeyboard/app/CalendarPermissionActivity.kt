...
/**
 * Invisible trampoline that shows the system calendar-permission dialog on
 * behalf of the IME (services cannot request runtime permissions). It
 * finishes as soon as the dialog is answered; the calendar panel re-checks
...
class CalendarPermissionActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        request.launch(android.Manifest.permission.READ_CALENDAR)
    }
}
