...
- Music: "Latin Industries" by Kevin MacLeod (incompetech.com), trimmed and
  ...
  **This attribution must accompany the published video** (e.g. in the YouTube
  description of the Play Store promo upload).
- Sound effects (public/sfx/*.wav): synthesized in-repo with ffmpeg lavfi
  (noise/sine sources); no third-party material.
