...
<PhoneFrame caption="The System-wide group on the Grammar check screen: Use Harper everywhere, and Underline only for Android 12 and up.">
  <Shot id="smart/spell-checker-options" alt="The System-wide group on the Grammar check screen: Use Harper everywhere, and Underline only for Android 12 and up." />
</PhoneFrame>
