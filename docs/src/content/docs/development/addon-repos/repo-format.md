---
title: "WM Keyboard Addon Repository Format"
...
See also: [CLIENT_DESIGN.md](/development/addon-repos/client-design/) for how the app fetches, resolves and installs these.
