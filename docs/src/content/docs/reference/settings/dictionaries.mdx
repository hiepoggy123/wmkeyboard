...
Every word the keyboard has learned from your typing, plus any you add by hand, sorted with the most-reinforced word first. Each row reads "You added this word" once its weight reaches 200, and "Seen N times" below that. New words the keyboard is still counting are not on this screen: they only appear once they have been typed enough times to be saved. See [Personal dictionary](/smart/personal-dictionary/#new-words-wait-their-turn).
