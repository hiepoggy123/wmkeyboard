...
Every word the keyboard has learned from your typing, plus any you add by hand, sorted with the most-reinforced word first. Each row reads "You added this word" once its weight reaches 200, and "Seen N times" below that.
