...
<PhoneFrame side caption="The Personal dictionary screen: learned and manually-added words, most-used first.">
  <Shot id="reference/settings/dictionary-personal" alt="The Personal dictionary screen: learned and manually-added words, most-used first." />
</PhoneFrame>
...
<PhoneFrame side caption="Custom dictionaries, grouped by language, with Import and From URL actions.">
  <Shot id="reference/settings/dictionary-custom" alt="Custom dictionaries, grouped by language, with Import and From URL actions." />
</PhoneFrame>
...
<PhoneFrame caption="The Suggestion blacklist editor, empty until you add a word.">
  <Shot id="reference/settings/dictionary-blacklist" alt="The Suggestion blacklist editor, empty until you add a word." />
</PhoneFrame>
...
<PhoneFrame side caption="Emoji keywords: the Downloads toggle, a bundled-catalog row, and an imported pack for one language.">
  <Shot id="reference/settings/dictionary-emoji-keywords" alt="Emoji keywords: the Downloads toggle, a bundled-catalog row, and an imported pack for one language." />
</PhoneFrame>
