...
- **No edition differences.** Nothing in the Addons, sticker-pack, or plugin screens, or the caps above, is gated to the full or lite build; both editions install and run the same twelve addon types.
