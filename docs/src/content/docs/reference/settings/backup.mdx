...
Unlike almost every other screen in this reference, none of these eleven switches are stored settings: they're local to the screen. Reopen **Backup & restore** later and every switch is back to the defaults above, regardless of what you chose last time.
:::
