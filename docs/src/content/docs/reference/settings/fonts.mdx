...
<PhoneFrame caption="The Keyboard font screen: English font section with Google Fonts, each row previewed in its own face.">
  <Shot id="reference/settings/fonts-english-section" alt="The Keyboard font screen: English font section with Google Fonts, each row previewed in its own face." />
</PhoneFrame>
