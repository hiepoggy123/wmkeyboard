...
<PhoneFrame caption="The Permissions screen: runtime permissions, special access, and the ones that come with the install.">
  <Shot id="reference/settings/permissions-screen" alt="The Permissions screen: runtime permissions, special access, and the ones that come with the install." />
</PhoneFrame>
...
| Install updates | Install a new version of this app that you downloaded from its release page | Android's "install unknown apps" page for WM Keyboard |
