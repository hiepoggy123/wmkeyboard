...
1. The file name has to match the release and your phone: the right edition, and the right CPU, falling back to the universal build if your CPU has no build of its own.
