...
description: "Version, licence, and source links, plus a diagnostics screen for pulling a shareable bug report."
sidebar:
  order: 20
---
...
<PhoneFrame caption="The About screen: Share, App, Documentation, Third party, and Word lists groups.">
...
- **Sharing a link isn't the same as opening one.** The three Share rows always hand off to the system share sheet with a pre-filled message; only Source code, User guide, and Privacy policy, and any row inside the licence browser without a bundled text, open a browser tab directly.
