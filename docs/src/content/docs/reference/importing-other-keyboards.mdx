...
**Keyman is a different story.** 862 Keyman key grids are already built into the app, so for most of them there's nothing to import. Opening a `.kmp` package or a `.keyman-touch-layout` file yourself isn't supported yet. See [Keyman layouts](/languages/keyman/).
