...
description: "Fourteen kinds of installable content, published by anyone with a static file host, installed with nothing more than a URL."
sidebar:
  label: "Overview"
  order: 1
---
...
<PhoneFrame caption="The Addons screen: repositories you've added, plus everything you've installed from them.">
  <Shot id="addons/addons-home" alt="The Addons screen: repositories you've added, plus everything you've installed from them." />
</PhoneFrame>
...
<PhoneFrame side caption="A plugin's detail page shows what it can do before you install it. This is the one addon type that isn't pure data.">
  <Shot id="addons/plugin-trust-preview" alt="A plugin's detail page shows what it can do before you install it — this is the one addon type that isn't pure data." />
</PhoneFrame>
...
The same store is on this site at [wmkeyboard.pages.dev/addons](/addons/): every repository the app seeds, plus any you add by URL, with live previews of themes, layouts, fonts, sounds and plugins before you install anything. On Android each addon page has an *Open in app* button; elsewhere, scan the QR code. It also has a [repository checker](/addons/check/) and [builders](/addons/new/) for themes, layouts, snippet packs, sticker packs, sound packs, icon packs and whole repositories.
