...
import bengali from '@assets/layouts/bn_jatiya.wmlayout.json';

{/* Languages and wordlists are computed from the generated data files; the
    rest are the code-verified figures from CONTENT_GUIDE.md. Layout count
    rechecked 2026-08-12 after the Keyman conversion landed. */}

<div class="wm-stats not-content">
	<a href="/languages/overview/"><strong>{languages.length}</strong> languages</a>
	<a href="/languages/custom-layouts/"><strong>1,274</strong> layouts</a>
	<a href="/languages/dictionaries/"><strong>{wordlists.length}</strong> wordlists</a>
	<a href="/tools/overview/"><strong>63</strong> toolbar tools</a>
	<a href="/tools/whisper/"><strong>29</strong> Whisper models</a>
...
<FeatureRow kicker="Voice typing" title="Speech that stays on the phone" href="/tools/whisper/" linkText="Set up Whisper" flip>
	...
	Dictate with Whisper running entirely on device. Pick from 29 models, tiny ones
...
<FeatureRow kicker="Languages" title="843 languages, one keyboard" href="/languages/overview/" linkText="Browse the languages">
	<Fragment slot="media"><LayoutExplorer layout={bengali} /></Fragment>
	This is the Bangla National (Jatiya) layout, rendered live from the same key
	data the app ships. Hover any key to peek at its long-press alternates, or tap
	shift for the second layer. Avro phonetic typing, custom layouts and per-field
	language detection are all part of the same system.
</FeatureRow>
