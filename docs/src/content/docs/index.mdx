---
title: "WM Keyboard"
description: "A modern, privacy-first Android keyboard: offline intelligence, 845 languages, themes, tools and an addon ecosystem."
template: splash
editUrl: false
lastUpdated: false
hero:
  title: 'Type anything. <span class="wm-gradient-text">Share nothing.</span>'
  tagline: A privacy-first Android keyboard for 845 languages, with offline prediction, a full tool belt, themes, addons and Lua plugins.
  actions:
    - text: Get started
...
<CardGrid>
	...
	<Card title="845 languages" icon="translate">
...
<FeatureRow kicker="Voice typing" title="Speech that stays on the phone" href="/tools/whisper/" linkText="Set up Whisper" flip>
	<Fragment slot="media">
		<PhoneFrame caption="The Whisper model catalog">
			<Shot id="tools/whisper-catalog" alt="The Whisper model catalog inside WM Keyboard settings" />
		</PhoneFrame>
	</Fragment>
...
<FeatureRow kicker="Languages" title="845 languages, one keyboard" href="/languages/overview/" linkText="Browse the languages">
...
<FeatureRow kicker="Privacy" title="Private by construction" href="/privacy/overview/" linkText="Read the privacy tour" flip>
	<Fragment slot="media">
		<PhoneFrame caption="On-device learning, under your control">
			<Shot id="privacy/on-device-learning-toggles" alt="The on-device learning toggles in settings" />
		</PhoneFrame>
	</Fragment>
