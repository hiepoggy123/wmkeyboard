---
title: "WM Keyboard"
description: "A modern, privacy-first Android keyboard: offline intelligence, 843 languages, themes, tools and an addon ecosystem."
template: splash
editUrl: false
lastUpdated: false
hero:
  title: 'Type anything. <span class="wm-gradient-text">Share nothing.</span>'
  tagline: A privacy-first Android keyboard for 843 languages, with offline prediction, a full tool belt, themes, addons and Lua plugins.
  actions:
    - text: Get started
...
<CardGrid>
	...
	<Card title="843 languages" icon="translate">
