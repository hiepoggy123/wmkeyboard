...
<PhoneFrame caption="The Calendar panel: month grid with Bengali day numbers, today's events listed below.">
  <Shot id="tools/calendar-month-grid" alt="The Calendar panel: month grid with Bengali day numbers, today's events listed below." />
</PhoneFrame>
...
<PhoneFrame caption="A day with events: colored stripe per calendar, time, and location.">
  <Shot id="tools/calendar-day-events" alt="A day with events: colored stripe per calendar, time, and location." />
</PhoneFrame>
...
Like every tool, Calendar opens with a **Turn on** switch and, while [colorful tool icons](/reference/settings/tools/) are on globally, an **Icon colour** override (a soft red by default). Under those sits the **Keyword shortcut** group: **Trigger words**, pre-filled with "calendar, schedule", a **Match capitals** toggle off by default, and a **Reset to defaults** row once you've edited the words. Then the tool's own settings:

<PhoneFrame side caption="Calendar options: the two calendar pickers, the weekend picker, and the Hijri day adjustment slider.">
  <Shot id="tools/calendar-options" alt="Calendar options: First and second calendar pickers, and the Hijri day adjustment slider." />
</PhoneFrame>
