...
- Every tool here has its own **Enabled** switch and, if [colorful tool icons](/tools/overview/#browsing-all-63-tools) are on globally, an **Icon colour** override; both live at the top of that tool's own settings screen, above everything documented in this page's Options sections.
