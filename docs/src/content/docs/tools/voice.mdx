...
All six sit in a group headed **Dictation**. An edition with the offline engine built in adds an **Engine** group above it, holding the **Recognition engine** choice (see [Offline voice (Whisper)](/tools/whisper/) for what that adds). With the system recognizer in use, the screen ends with this note about what it sends:
