...
- **Icon colour** — only shown while [colorful tool icons](/reference/settings/tools/) is on globally (it is by default). Text scan is green, QR & barcode teal, Document scanner a light blue.
