...
description: "Build the Cipher Tool — a two-tab plugin panel — with nothing but a text editor."
sidebar:
...
- [API_REFERENCE.md](/plugins/api-reference/) — every widget, event and function.
- [PERMISSIONS.md](/plugins/permissions/) — how to ask for storage, and why that is the
