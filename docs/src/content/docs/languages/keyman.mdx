...
They behave like any other layout once enabled. They appear under their language in <SettingsPath path="Languages & layouts" />, they're editable in the layout editor, and you can export one as a file like any other.
