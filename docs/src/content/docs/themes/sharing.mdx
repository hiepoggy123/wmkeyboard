...
<PhoneFrame caption="The theme gallery, with export and import actions above the cards.">
  ![The theme gallery, with export and import actions above the cards.](@assets/screens/themes/gallery-export-import.webp)
</PhoneFrame>
