...
<PhoneFrame caption="The theme gallery: the create and import actions above the cards, and an export icon on each card.">
  ![The theme gallery: the create and import actions above the cards, and an export icon on each card.](@assets/screens/themes/gallery-export-import.webp)
</PhoneFrame>
...
There are three ways a theme gets imported, and they don't all behave the same way: two apply the theme immediately, one doesn't. Two more buttons on the same row, **FlorisBoard** and **HeliBoard**, read someone else's format rather than this one. They're covered separately below.
