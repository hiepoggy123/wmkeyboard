...
<PhoneFrame caption="The Icons screen: the active pack, and every replaceable slot grouped by where it appears.">
  {/* shot: themes/icons-screen-overview */}
</PhoneFrame>
