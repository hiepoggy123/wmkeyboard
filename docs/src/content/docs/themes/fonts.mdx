...
<PhoneFrame caption="The Keyboard font screen: curated Google Fonts, each row previewed in its own face.">
  <Shot id="themes/font-picker-english" alt="The Keyboard font screen: curated Google Fonts, each row previewed in its own face." />
</PhoneFrame>
...
<PhoneFrame caption="A script-specific picker (Devanagari): the automatic Noto face, a short curated list, and any installed fonts that cover the script.">
  <Shot id="themes/font-picker-script" alt="A script-specific picker (Devanagari): the automatic Noto face, a short curated list, and any installed fonts that declare coverage for the script." />
</PhoneFrame>
