...
<PhoneFrame caption="Network activity: the live line, today's totals with the chart split by feature, and the By feature and Servers contacted cards.">
  <Shot id="privacy/network-activity-screen" alt="Network activity: the live line, today's totals with the chart split by feature, and the By feature and Servers contacted cards." />
</PhoneFrame>
